...
import os
from src.app import create_app # Import the factory function
...
if __name__ == '__main__':
    ...
    debug = os.environ.get('FLASK_DEBUG', 'True').lower() == 'true' # Example of env var config

    print(f"\nStarting Flask app. Access at http://{host}:{port}")
    print(f"Debug mode: {debug}")
    print(f"Using server-side sessions (type: {app.config.get('SESSION_TYPE', 'filesystem')}).")
