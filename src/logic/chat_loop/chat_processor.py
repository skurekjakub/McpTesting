...
try:
    ...
    utils.add_debug_log(f"Successfully loaded system instruction from {SYSTEM_INSTRUCTION_FILE}")
except FileNotFoundError:
    utils.add_debug_log(f"Warning: System instruction file not found at {SYSTEM_INSTRUCTION_FILE}. Using default.")
...
async def process_prompt(
    ...
    while function_call_count < MAX_FUNCTION_CALLS_PER_TURN:
        ...
        text_response_from_candidate, should_continue = await chat_helpers.process_candidate(
